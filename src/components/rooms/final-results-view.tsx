  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 sm:p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3 border-t border-zinc-100 dark:border-zinc-800 text-xs">
          <div className="space-y-0.5">
            <span className="text-zinc-500 dark:text-zinc-400">Total Reward Pool</span>
            <p className="text-lg font-bold text-amber-700 dark:text-amber-400">
              {room.points_pool} pts
            </p>
          </div>
          <div className="space-y-0.5">
            <span className="text-zinc-500 dark:text-zinc-400">Warriors Enrolled</span>
            <p className="text-lg font-bold text-zinc-900 dark:text-white">
              {participants.length}
            </p>
          </div>
          <div className="space-y-0.5">
            <span className="text-zinc-500 dark:text-zinc-400">Check-Ins Completed</span>
            <p className="text-lg font-bold text-zinc-900 dark:text-white">
              {totalCheckIns}
            </p>
          </div>
          <div className="space-y-0.5">
            <span className="text-zinc-500 dark:text-zinc-400">Entry Stake</span>
            <p className="text-lg font-bold text-zinc-900 dark:text-white">
      ...
      {myEntry && (
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            {myPayout > 0 && (
              <div className="rounded-xl border border-amber-200 bg-white/90 px-4 py-3 text-right dark:border-amber-900 dark:bg-zinc-900 sm:min-w-[160px]">
                <span className="text-[11px] font-semibold uppercase text-amber-800 dark:text-amber-300">
                  Earned Reward
                </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Rank 1: Gold */}
        {top1 && (
          <div className="rounded-2xl border border-amber-300 bg-gradient-to-b from-amber-50/80 to-white p-5 shadow-sm dark:border-amber-800 dark:from-amber-950/40 dark:to-zinc-900 flex flex-col justify-between space-y-3">
            <div className="flex items-center justify-between">
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-amber-400/20 text-base shadow-sm">
                👑
              </span>
        ...
        {/* Rank 2: Silver */}
        {top2 && (
          <div className="rounded-2xl border border-slate-300 bg-gradient-to-b from-slate-50/80 to-white p-5 shadow-sm dark:border-zinc-700 dark:from-zinc-800/40 dark:to-zinc-900 flex flex-col justify-between space-y-3">
            <div className="flex items-center justify-between">
              <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-slate-200/60 text-base shadow-sm dark:bg-zinc-800">
                🥈
              </span>
              <span className="rounded-full bg-slate-100 px-2.5 py-0.5 text-[11px] font-bold text-slate-700 dark:bg-zinc-800 dark:text-zinc-300">
                Runner-Up &bull; #2
              </span>
            </div>
        ...
        {/* Rank 3: Bronze */}
        {top3 && (
          <div className="rounded-2xl border border-orange-300 bg-gradient-to-b from-orange-50/80 to-white p-5 shadow-sm dark:border-orange-900/60 dark:from-orange-950/30 dark:to-zinc-900 flex flex-col justify-between space-y-3">
            <div className="flex items-center justify-between">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <span className="font-mono font-extrabold text-xs text-zinc-500 dark:text-zinc-400 w-6 text-center shrink-0">
                    #{rank}
                  </span>
                ...
                <div className="flex items-center gap-4 shrink-0 text-xs">
                  ...
                  <div className="text-right min-w-[70px]">
                    {p.payout_received > 0 ? (
                      <span className="inline-flex items-center gap-1 rounded-lg bg-amber-100 dark:bg-amber-950 px-2 py-1 font-bold text-amber-800 dark:text-amber-300">
      ...
      <div className="rounded-xl border border-dashed border-zinc-200 bg-zinc-50/70 p-4 dark:border-zinc-800 dark:bg-zinc-800/30 text-xs text-zinc-600 dark:text-zinc-400 space-y-1.5">
