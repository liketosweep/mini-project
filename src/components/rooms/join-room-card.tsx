    ...
    <div className="rounded-2xl border border-sand-200 bg-white p-6 sm:p-8 shadow-sm dark:border-brand-800 dark:bg-brand-900 space-y-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-brand-50 px-3 py-1 text-xs font-semibold text-brand-700 dark:bg-brand-950/50 dark:text-brand-300">
            <Swords className="h-3.5 w-3.5" />
            Private Challenge Invite
          </span>

          <span className="font-mono text-xs text-zinc-500 dark:text-sand-400 bg-sand-100 dark:bg-brand-800 px-2 py-0.5 rounded">
            {inviteCode}
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
        {/* Entry Stake & Pool */}
        <div className="rounded-xl border border-sand-200 bg-sand-50/70 p-3.5 dark:border-brand-800 dark:bg-brand-800/40 space-y-1">
          <div className="flex items-center gap-1.5 font-semibold text-gold-800 dark:text-gold-300">
        ...
        {/* Participants count */}
        <div className="rounded-xl border border-sand-200 bg-sand-50/70 p-3.5 dark:border-brand-800 dark:bg-brand-800/40 space-y-1">
          <div className="flex items-center gap-1.5 font-semibold text-zinc-700 dark:text-sand-300">
        ...
        {isAlreadyJoined ? (
          ...
          <div className="space-y-3">
            ...
            <Link
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gold-500 py-3 text-sm font-semibold text-white shadow-sm hover:bg-brand-500 transition-colors"
            >
          ...
          /* Deadline passed */
          <div className="space-y-3">
            <div className="flex items-center gap-2 rounded-xl bg-gold-50 p-3 text-xs text-gold-800 dark:bg-gold-950/40 dark:text-gold-300">
              <ShieldAlert className="h-4 w-4 text-gold-600 dark:text-gold-400 shrink-0" />
              <span>The acceptance deadline for this challenge room has passed.</span>
            </div>
            <Link
              href="/rooms"
              className="inline-flex w-full items-center justify-center rounded-xl border border-sand-300 py-2.5 text-xs font-semibold text-zinc-700 hover:bg-sand-50 dark:border-brand-700 dark:text-sand-300 dark:hover:bg-brand-800 transition-colors"
            >
              Back to Challenges
            </Link>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <Link
              href="/rooms"
              className="w-full sm:w-auto text-center rounded-xl border border-sand-300 px-4 py-2.5 text-xs font-semibold text-zinc-700 hover:bg-sand-50 dark:border-brand-700 dark:text-sand-300 dark:hover:bg-brand-800 transition-colors"
            >
              Cancel
            </Link>
            <button
              ...
              onClick={handleJoin}
              disabled={isJoining}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-gold-500 px-6 py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-brand-500 disabled:opacity-50 transition-colors"
            >
