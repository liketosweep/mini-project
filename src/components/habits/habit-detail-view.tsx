  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <Link
          href="/habits"
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-zinc-600 hover:text-zinc-900 dark:text-sand-400 dark:hover:text-white transition-colors"
        >
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-xl border border-sand-200 px-3.5 py-2 text-xs font-semibold text-zinc-700 hover:bg-sand-100 dark:border-brand-800 dark:text-sand-300 dark:hover:bg-brand-800 transition-colors"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl border border-sand-200 px-3.5 py-2 text-xs font-semibold text-zinc-700 hover:bg-red-50 hover:border-red-200 hover:text-red-700 dark:border-brand-800 dark:text-sand-300 dark:hover:bg-red-950/30 dark:hover:text-red-400 disabled:opacity-50 transition-colors"
          >
            {isArchiving ? (
      ...
      <div className="rounded-2xl border border-sand-200 bg-white p-6 sm:p-8 shadow-sm dark:border-brand-800 dark:bg-brand-900 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div className="space-y-2 max-w-2xl">
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1 rounded-md bg-brand-50 px-2.5 py-1 text-xs font-semibold text-brand-700 dark:bg-brand-950/50 dark:text-brand-300">
              ...
              {completedToday ? (
                ...
                <span className="inline-flex items-center gap-1.5 rounded-md bg-gold-50 px-2.5 py-1 text-xs font-semibold text-gold-700 border border-gold-200 dark:bg-gold-950/40 dark:border-gold-900 dark:text-gold-300">
        ...
        {/* 4 Stat Indicators */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4 border-t border-sand-100 dark:border-brand-800">
          <div className="rounded-xl bg-sand-50 p-4 text-center dark:bg-brand-800/60">
            <span className="text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-sand-400">
              Current Streak
            </span>
          ...
          <div className="rounded-xl bg-sand-50 p-4 text-center dark:bg-brand-800/60">
            ...
            <div className="mt-1.5 flex items-center justify-center gap-1 text-xs font-mono font-bold text-zinc-800 dark:text-sand-200">
      ...
      <div className="rounded-2xl border border-sand-200 bg-white p-6 shadow-sm dark:border-brand-800 dark:bg-brand-900 space-y-4">
        ...
        {logs.length === 0 ? (
          <div className="rounded-xl border border-dashed border-sand-200 p-8 text-center dark:border-brand-800 space-y-2">
            ...
            <p className="text-sm font-medium text-zinc-700 dark:text-sand-300">
          ...
          <div className="divide-y divide-sand-100 dark:divide-brand-800 overflow-hidden">
            {logs.map((log) => (
              <div
                key={log.id}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {log.note && (
                      <p className="mt-0.5 text-xs text-zinc-600 dark:text-sand-400 flex items-start gap-1">
